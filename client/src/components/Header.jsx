...
const Header = () => {
  ...
  return (
    <div className="flex flex-col items-center mt-20 px-4 text-center text-gray-800">
        ...
        alt="Header" 
        className="w-36 h-36 rounded-full mb-6 header-img"  // Apply the header-img class here
      />
      ...
      <h2 className="text-3xl sm-text-5xl font-semibold mb-4 animate-text mr-8">
        Welcome to Earth!
      </h2>
